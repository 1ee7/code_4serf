/** @file
 *	@brief MAVLink comm protocol generated from tx1control.xml
 *	@see http://mavlink.org
 */
#ifndef MAVLINK_TX1CONTROL_H
#define MAVLINK_TX1CONTROL_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_TX1CONTROL.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_tx1_test_types.h"
